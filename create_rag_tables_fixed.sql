-- ========================================
-- Supabase Studio で実行するRAGテーブル作成SQL（修正版）
-- ========================================
...
CREATE TABLE rag_documents (
  ...
  search_text text,              -- title + description + copied_content + keywords の結合
...
-- 8. PGroongaインデックス作成（修正版・エラー対策済み）
-- 個別カラムのシンプルなインデックス
...
-- 完了メッセージ
SELECT 'RAGテーブル作成完了（PGroonga修正版）！次にinsert_sample_data.jsを実行してデータを投入してください。' as status;